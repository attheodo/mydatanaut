...
class GroupClassifications:
    ...
    def handle(
        self, rows: Optional[List[InvoiceRow]], options: Dict = None
        ...
        :return: A tuple of income classifications and expense classifications.
        """
        if not rows:
            return [], []
    ...
    def _flatten_income_classifications(
        ...
        """
        Flattens the income classifications into a list.
        """
    ...
    def _flatten_expenses_classifications(
        ...
        """
        Flattens the expense classifications into a list.
        """
    ...
    def _group_income_classifications(self, row: InvoiceRow) -> None:
        """
        Groups income classifications from an invoice row.
        """
    ...
    def _group_expenses_classifications(self, row: InvoiceRow) -> None:
        """
        Groups expense classifications from an invoice row.
        """
    ...
    def _get_summarized_expenses_classification(
        ...
        """
        Retrieves the summarized value of a specific key from an expense classification.
        """
        category_key = ecls.classification_category.value or ""
        type_key = ecls.classification_type.value or ""
        vat_category_key = ecls.vat_category.value or ""
